...
class WebView(ModalView):
    ...
    def __init__(self, url, enable_javascript = False, enable_downloads = False,
        ...
        self.custom_user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
        self.open()
    ...
    def on_open(self):
        ...
        webview.getSettings().setUserAgentString(self.custom_user_agent)
